...
public class A_retiro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aretiro);
    ...
    public void confirmar(View obj_vista) {
        ...
        if (str_valor.equals("") || !str_valor.matches("[0-9]+")) {
            ...
            if (valor <= 5000 || valor > Vista_2.saldo) {
                ...
                obj_carga.setMessage("Procesando Retiro...");
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        // Una vez completado el proceso de retiro, actualiza el saldo y cierra el ProgressDialog
                        Vista_2.saldo -= valor;
                        obj_carga.dismiss();
                        // mensaje de éxito
                        Toast.makeText(A_retiro.this, "Retiro exitoso", Toast.LENGTH_SHORT).show();
